            ...
            <div className=" py-3">
              ...
              <ul className=' flex items-center gap-4'>
                <li className=" p-2 rounded hover:bg-neutral-600 transition-colors duration-150 ease-in">
                  <Link to='https://www.facebook.com/profile.php?id=61579726685916'>
                  <span>
                ...
                <li className=" p-2 rounded hover:bg-neutral-600 transition-colors duration-150 ease-in">
                  <Link to='https://www.instagram.com/kcraftking_designs?igsh=MW5hcnI3dTl2OTA5OQ=='>
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgba(255,255,255,1)" className=' size-6'>
                ...
                <li className=" p-2 rounded hover:bg-neutral-600 transition-colors duration-150 ease-in">
                  <Link to='https://x.com/KCRAF_TKING?t=r425dkylbXAsKiztmJA_Dw&s=09'>
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgba(255,255,255,1)" className=' size-6'>
                ...
                <li>
                  <Link to='https://vm.tiktok.com/ZNdsYNMTo/'>
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="rgba(255,255,255,1)" className="size-6">
                         <path d="M240 96.7v42.6c-23.5 0-46.4-7.5-65.1-21.4v71.5c0 41.3-33.6 74.8-74.9 74.8S25 230.7 25 189.4c0-41.3 33.6-74.9 74.9-74.9 3.4 0 6.8.3 10.1.8v43.5c-3.3-.9-6.7-1.5-10.1-1.5-17.4 0-31.6 14.2-31.6 31.7 0 17.4 14.2 31.6 31.6 31.6 17.5 0 31.7-14.2 31.7-31.6V21h42.6c0 24.1 19.6 43.7 43.7 43.7h0z"/>
                    </svg>
                  </span>
                  </Link>
                </li>
